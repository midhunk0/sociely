...
const { registerUser, loginUser, logoutUser, fetchProfile, searchUser, fetchUser, toggleFollowUser, fetchFollowers, fetchFollowings, deleteUser, updateUser, addPost, editPost, deletePost, toggleLike, addComment, editComment, deleteComment, sendOTP, verifyOTP }=require("../controllers/controller");
...
router.post("/addPost", upload.single("image"), authMiddleware, addPost);
router.put("/editPost/:postId", upload.single("image"), authMiddleware, editPost);
